...
/**
 * The MenuBarToggleItem class contains class fields and methods for the menu bar item.
 *
 * @author <a href="mailto:markus.karnik@my-design.org">Markus Karnik</a>
 * @version 1.0
 * @since v.0.0.7
 */
public class MenuBarToggleItem extends JToggleButton {
   ...
   */
  public MenuBarToggleItem(String actionCommand, String iconCodeAsText) throws JIPSException {
    this();
